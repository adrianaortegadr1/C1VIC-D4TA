...
st.set_page_config(layout="wide", page_title="C1VIC D4TA · Máxima Verosimilitud: Bernoulli vs Normal")
...
def main():
    ...
    st.markdown(
        "<div class='top-bar-title'>C1VIC D4TA · Máxima Verosimilitud: Bernoulli vs Normal</div>",
        unsafe_allow_html=True
    )
