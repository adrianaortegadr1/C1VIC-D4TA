...
def main():
    ...
    with col_left:
        ...
        <div class='comment-box'>
            ...
            • <b>Insesgadez:</b> El valor esperado del estimador es exactamente el parámetro real E[π^] = π.<br>
            • <b>Consistencia:</b> Conforme n → ∞, el error del estimador se reduce a cero.<br><br>
